...
def crop_random(image_ori, width=64,height=64, x=None, y=None, overlap=7, isShake = False):
    ...
    image[int(random_y + overlap):int(random_y+height - overlap), int(random_x + overlap):int(random_x+width - overlap), 0] = 2*117. / 255. - 1.
    image[int(random_y + overlap):int(random_y+height - overlap), int(random_x + overlap):int(random_x+width - overlap), 1] = 2*104. / 255. - 1.
    image[int(random_y + overlap):int(random_y+height - overlap), int(random_x + overlap):int(random_x+width - overlap), 2] = 2*123. / 255. - 1.
